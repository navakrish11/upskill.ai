...
const solutions = [
  {
    id: "ai-trainer",
    title: "AI Trainer",
    description: "Turn static training into interactive learning. Digitizes PDFs, PPTs, and manuals into voice-narrated training experiences with configurable avatars, chapters, and Q&A support.",
    ...
    techDetails: {
      technologies: ["React Native", "Langchain", "OpenAI GPT-4o", "Blob", "Next.js", "Node.js"],
