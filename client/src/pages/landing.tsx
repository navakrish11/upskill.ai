...
import aiTrainerVideo from "@assets/Introduction to AI Trainer_1752322156290.mp4";

const solutions = [
  {
    id: "ai-trainer",
    title: "AI Trainer",
    description: "Turn static training into interactive learning. Digitizes PDFs, PPTs, and Manuals into narrated video modules",
  ...
  },
  {
    ...
    videoSrc: "gamification-demo.mp4",
